    ...
    render(){
        ...
        <div style = {{backgroundColor: '#E7F7F7'}}>
            <Fragment>
                ...
                <Container fluid style ={{background:"#90a7a7"}} >
                        <Row fluid style= {{paddingTop:"0px"}}>
                            <Col md = {{span:8}} style= {{paddingLeft:"0px", paddingTop:"0px"}}>
                                <Image src = {BackgroundTrain} style = {{maxWidth: "100%", height:"auto"}}/>
                            </Col>    
                            <Col md style= {{paddingLeft:"0px", paddingTop:"0px"}}>
                                <div fluid style= {{paddingRight:"30px"}}>
                                <Row>
                                    <h1 fluid style= {{textAlign:"left",paddingRight:"50px", paddingTop:"50px"}}><strong>Bay Area Rapid Transit</strong></h1>
                                </Row>
                                <Row>
                                    <h3 style= {{textAlign:"left", paddingLeft: "10px", paddingRight:"50px"}}><small>Capital Project Managment Database</small></h3>
                                </Row>  
                                <Row style = {{textAlign:"left", paddingLeft: "20px", paddingRight:"50px"}}>
                ...
                <p></p>
                <Navbar class = "navbar fixed-bottom" expand = 'lg' sticky = 'bottom' bg = 'dark' width = '50px'>
                    <p></p>
                </Navbar>
        </Fragment>
        </div>
